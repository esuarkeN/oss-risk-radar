...
This glossary explains the recurring technical terms of the thesis. Terms from
machine-learning practice are defined in the sense in which they are standard in
that literature; where this thesis defines a term of its own, the entry says so.
The formal equations for the evaluation metrics are given in
...
(Section~\ref{sec:results-bot-ablation}) and for feature availability
